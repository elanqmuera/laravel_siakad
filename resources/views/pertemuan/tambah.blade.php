...
@section('content2')
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="container-xl">
                <form action="{{ route('pertemuan.simpan') }}" method="POST" class="card">
                    @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control @error('pertemuan')is-invalid @enderror"
                                            id="pertemuan" value="{{ old('pertemuan') }}" name="pertemuan"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control @error('deskripsi')is-invalid @enderror"
                                            id="deskripsi" value="{{ old('deskripsi') }}" name="deskripsi"
