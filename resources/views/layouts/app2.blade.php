...
<body>
        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href=".">
                        <img src="{{ asset('tabler/demo') }}/static/logo-polsub.png" width="110" height="32"
    ...
    <!-- Libs JS -->
    <script src="{{ asset('tabler/demo') }}/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062" defer></script>
    <script src="{{ asset('tabler/demo') }}/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062" defer></script>
    <script src="{{ asset('tabler/demo') }}/dist/libs/jsvectormap/dist/maps/world.js?1684106062" defer></script>
    <script
        src="{{ asset('tabler/demo') }}{{ asset('tabler/demo') }}/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062"
        defer></script>
