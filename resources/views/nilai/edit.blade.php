...
@section('content2')
    <div class="page-wrapper">
        ...
        <div class="page-body">
            <div class="container-xl">
                <form action="{{ route('nilai.update', $nilai->id_nilai) }}" method="POST" class="card">
                    @csrf
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('id_tugas')is-invalid @enderror" id="id_tugas"
                                        ...
                                        @enderror
                                        <option value="{{ $nilai->id_tugas }}">{{ $nilai->nama_tugas }}</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('id_mahasiswa')is-invalid @enderror"
                                        ...
                                        @error('id_mahasiswa')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                        <option value="{{ $nilai->id_mahasiswa }}">{{ $nilai->nama_mahasiswa }}</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control @error('nilai')is-invalid @enderror"
                                            id="nilai" value="{{ $nilai->nilai }}" name="nilai"
