...
<div class="col-12 grid-margin stretch-card">
 <div class="card">
   <div class="card-body">
     ...
     <form  action="{{route('dosen.simpan')}}" method="POST" class="forms-sample">
      @csrf 
      ...
      <div class="form-group">
         ...
         <input type="text" class="form-control @error('nama_dosen')is-invalid @enderror" name="nama_dosen" id="nama_dosen" placeholder="Nama Dosen">
         @error('nama_dosen')
         <span class="invalid-feedback">{{ $message }}</span>
     @enderror
        </div>
