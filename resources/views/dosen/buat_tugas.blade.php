    ...
    <div class="page-wrapper">
        ...
        <div class="page-body">
            ...
            <div class="container-xl">
                ...
                @endif
                <a href="{{ route('buat_tugas.tambah') }}" class="btn btn-primary mr-2">Buat Tugas</a> <br> <br>
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('tugas.edit', $item->id_tugas) }}">Edit</a>
                                                    <a class="btn btn-danger"
                                                        onclick="return confirm('Apakah Anda Yakin Menghapus Data?')"
                                                        href="{{ route('tugas.hapus', $item->id_tugas) }}">Hapus</a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
